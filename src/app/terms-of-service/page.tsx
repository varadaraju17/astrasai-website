  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-void-950 pt-32 pb-24">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
        <div className="absolute top-1/4 -right-64 w-96 h-96 bg-neon-blue/10 rounded-full blur-[128px]"></div>
        <div className="absolute bottom-1/4 -left-64 w-96 h-96 bg-neon-purple/10 rounded-full blur-[128px]"></div>
      </div>
